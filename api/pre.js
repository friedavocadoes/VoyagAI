...
async function run(mood, budget, loc) {
    const prompt = `I want you to suggest me 12 vacation spots (around the world) based on my mood and budget.
    ...
    This is how i want the structure of the json to be: {"vacation_spots":[{"name":<name of the place>, "description":<the description>, "pict":<picture link>}, {"name":<name of the place>, "description":<the description>, "pict":<picture link>}, <and 10 more>]}.
