...
async function run(mood, budget, loc) {
    ...
    I want the response to be a json with the names of the places, a description about each, ways to travel to the location, stay options (hotels and resorts) at the location, a budget plan and a hyperlink to a website about that place from the internet.
