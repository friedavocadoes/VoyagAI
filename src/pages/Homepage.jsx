  ...
  return (
    <div className="relative px-6 pt-14 flex items-center justify-center min-h-screen">
      ...
      <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="/generator" class="rounded-md bg-[#f9b17a] px-3.5 py-2.5 text-md font-bold text-[#2d3250] shadow-sm hover:bg-[#767fb4] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Start planning with AI</a>
        </div>
      </div>
    </div>
  );
